...
df_stm <- merge(df_ols, df_stm, by = c("Data", "Cod_IBGE_Mun"), all.x = T) %>% 
  ...
  group_by(Ano_Mes, Cod_IBGE_Mun, Ano, Mes, eleicao, Receitas_pCap, n_OSCs, AB2_Recursos_Hídricos_Seca, AB2_Segurança_Alimentar_Seca, AB2_Segurança_Alimentar_Chuva,       AB2_Desastres_Hidrológicos_Inundações_enxurradas_e_alagamentos, AB2_Desastres_Hidrológicos_Deslizamento_de_terra) %>% 
...
cor_matrix <- cor(df_stm[, c("agenda_clima", "Desastre", "Obitos",
                             "dias_proxima_eleicao", "Receitas_pCap", "n_OSCs",
                             "AB2_Recursos_Hídricos_Seca", 
                             "AB2_Segurança_Alimentar_Seca", "AB2_Segurança_Alimentar_Chuva",
                             "AB2_Desastres_Hidrológicos_Inundações_enxurradas_e_alagamentos",

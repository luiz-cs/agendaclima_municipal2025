...
ggsave(here("Figuras/2.5.4.1.Proposituras_Dimensao_Risco.png"), prop_dimensao_risco, width = 10, height = 10)
...
prop_dimensao_risco <- dfrisco2 %>% 
  ...
  theme(legend.position = "none",
        ...
        legend.text = element_text(size = 10),
        strip.text = element_text(size = 10))+
  facet_grid(Tipo~Risco_Climatico)

prop_dimensao_risco

ggsave(here("Figuras/2.5.4.3.Proposituras_Dimensao_Risco_Tipo.png"), prop_dimensao_risco, width = 10, height = 15)

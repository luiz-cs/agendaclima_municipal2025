...
### Salvar paletas e remover demais

```{r}
paletas <- c(paleta_climatermos, paleta_desastres, paleta_proposituras, paleta_regiao)

saveRDS(object = paletas, here("Dados/paletas.RDS"))

...
uf_num <- uf %>%
  ...
  geom_col() +
  scale_fill_manual(values = paleta_regiao$Cores, limits = paleta_regiao$UF) +
...
ggsave(here("Figuras/2.1.3.Distribuição da População.png"), pop_gg)
...
ggsave(here("Figuras/2.2.910Sazonalidade_Proposituras.png"), sazonalidade)
...
ggsave(here("Figuras/2.2.911Sazonalidade_Proposituras.png"), psazonalidade)

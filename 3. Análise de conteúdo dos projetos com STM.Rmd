...
ggsave(here("Figuras/3.4.6P_Topicos_Mes.png"), Mes_Topicos)
...
ggsave(here("Figuras/3.5.2.1Boxplot_Maior_Topico_PL.png"), box_topicos, width = 10, height = 6)
...
ggsave(here("Figuras/3.6.10Distribuição_N_Municipios_estrito.png"), mun_n_clima, height = 3, width = 10)

...
rm(sazon_desastres, mes_todos_des, Desastres)
```
...
ggsave(here("Figuras/2.5.1.2Densidade_proposituras_desastre.png"), prop_dias_tipos_desastres)

rm(prop_dias_tipos_desastres)

```

### 2.5.1.3 Tipo de Proposituras x Dias após Desastre
...
ggsave(here("Figuras/2.5.1.3 Densidade_tipos_proposituras_dias_desastre.png"), tiproj_dias_desastres)
...
ggsave(here("Figuras/2.5.1.4Densidade_tipos_proposituras_e_desastre.png"), tiproj_dias_desastres, width = 15, height = 20)
...
ggsave(here("Figuras/2.5.3.2 Densidade_termos_e_desastre.png"), termos_dias_tipo_desastres, width = 15, height = 18)
...
ggsave(here("Figuras/2.5.4.1.Proposituras_Dimensao_Risco.png"), prop_dimensao_risco, width = 6, height = 9)
...
ggsave(here("Figuras/2.5.4.2Proposituras_Indicador_Risco.png"), prop_indicador_risco, width = 15, height = 20)
...
ggsave(here("Figuras/2.5.4.3.Desastres_Indicador_Risco.png"), climaXdesastres, width = 10, height = 10)
...
ggsave(here("Figuras/2.5.4.4.Obitos_Indicador_Risco.png"), climaXobitos, width = 15, height = 15)
...
ggsave(here("Figuras/2.5.5.1.Proposituras_OSCs.png"),proposituras_oscs)
...
ggsave(here("Figuras/2.5.5.2.Tipos_Proposituras_OSCs.png"),tipos_proposituras_oscs)
...
ggsave(here("Figuras/2.5.6.1.Proposituras_Orcamento.png"),proposituras_orcamento)
...
ggsave(here("Figuras/2.5.7.1 Histograma proposituras até próxima eleição.png"), prop_dias_eleicao)

...
ALClima13_23[Municipio_UF == "saovaleriodanatividade_TO", Municipio_UF := "saovalerio_TO"] #Corrigindo nome de município que não bate com os demais
...
```{r}
saveRDS(df, here("Dados/dfagendaclima_municipal.RDS"))

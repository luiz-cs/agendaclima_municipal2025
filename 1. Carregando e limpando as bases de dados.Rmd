...
ALClima_next <- ALClima %>%
  ...
  ungroup() %>%
  select(UF, Municipio_UF, Cod_IBGE_Mun, Data, data_desastre_proximo2 = Data_desastre, desastre_proximo2 = Desastre)
...
ALClima <- ALClima %>%
  ...
  mutate(
    dias_desastre_anterior2 = as.integer(Data - data_desastre_anterior),
    dias_desastre_proximo2 = as.integer(Data - data_desastre_proximo)
  )
...
rm(ALClima_prev, ALClima_next, lista_municipios, DesastresSAPL)
